		...
		<>
			...
			<main className='bg-red-400 h-full max-w-full mx-5 lg:mx-17 xl:mx-23.75'>
				<section className='flex flex-col-reverse md:flex-row justify-around items-center gap-10'>
					...
					<div className='flex flex-col gap-10'>
						...
						<CIcon
							...
							w='w-50'
							h='h-20'
							position='top-10 left-10 -rotate-90 -scale-100'
					...
					<div className='flex justify-around'>
						<div className='flex flex-col gap-2.5'>
							...
							<CIcon
								...
								w='w-38'
								h='h-[111px]'
								position='top-0 left-30 rotate-90 -scale-100'
								src='/svg/CurlArrow.svg'
								alt='CurlArrow'
							/>
						</div>
				...
				<section className='flex flex-col gap-13.75 items-center'>
					...
					/>
					<ReviewCarousel>{revs}</ReviewCarousel>
				</section>
