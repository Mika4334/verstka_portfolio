...
export function ArticleSlider({ children, forceCol, showButton }) {
	...
	return (
		<>
			...
			<div
				className={`${forceCol ? "hidden" : ""} ${showButton ? "flex items-center gap-10" : "hidden"}`}
			>
				<button
					onClick={prevSlide}
					disabled={cStep === 0}
