                ...
                <form className='min-w-79 w-full max-w-97 flex gap-8 flex-col justify-center items-center'>
                    ...
                    <div className='flex flex-col gap-5 w-full'>
                        <div className="relative group">
                            ...
                            <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <div className=" w-5 h-5 bg-gray-400 group-focus-within:bg-pm
            ...
            <div className='max-w-116.5 w-full flex flex-col items-center'>
                <form className='min-w-79 w-full max-w-97 flex gap-8 flex-col justify-center items-center'>
                    ...
                    <div className='flex flex-col gap-5 w-full'>
                        ...
                        <a className='self-end text-pm font-bold' href="">Forgot Password ?</a>
                    </div>
                    <PrimaryButton textValue='Sign up' height='h-15' uppercase />
                    <div>
                        <p>Create A New Account? <a className='text-pm font-bold' href="">Sign Up</a></p>
                    </div>
                </form>
                <div className='sm:flex justify-between w-full hidden'>
                    <p>Privacy Policy</p>
