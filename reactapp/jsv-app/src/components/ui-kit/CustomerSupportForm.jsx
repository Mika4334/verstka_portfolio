        ...
        <>
            <div className='md:block w-full hidden'>
                <div className='flex justify-between'>
                    <CImage src='/img/CustomerLeft.png' alt='MobileScreen' w='w-2/1' />
                    <div className='flex w-full justify-start items-right md:pr-18 lg:pr-25'>
                        <div>
                            ...
                            <form className='mt-15' action="" method="post">
                                <input className='ContactUsInputs' placeholder='FULL NAME' type="text" autoComplete="given-name" />
                                {/* <input className='ContactUsInputs' placeholder='FULL NAME' type="text" autoComplete="family-name" /> */}
                                <input className='ContactUsInputs' placeholder='ENTER YOUR EMAIL' type="email" pattern=".+@exemple\.com" autoComplete="off" />
                                <textarea className='ContactUsTextarea' placeholder='ENTER THE PROBLEM OR QUERY' rows="14"></textarea>
            ...
            <div className='block md:hidden'>
                <div className='grid grid-cols-3 bg-pm max-w-full h-38'>
                    <CImage src='/svg/CurlArrow90.svg' alt='CurlArrow' w='min-w-40' h='min-h-41' imgH='h-min-41' />
                    <h4 className='text-nowrap text-white text-[24px]/[120%]'>Contact Us</h4>
                </div>
